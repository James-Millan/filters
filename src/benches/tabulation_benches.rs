...
//
// static SAMPLE_SIZE: u64 = 10000000;
...
//         }
//         b.iter(|| {
//             let binary_fuse_filter = binaryfusefiter3::ThreeWiseBinaryFuseFilter8::new(keys.clone());
...
//         keys.push(i);
//     }
//     let binary_fuse_filter = RefCell::new(binaryfusefiter3::ThreeWiseBinaryFuseFilter8::new(keys.clone()));
//     let mut i: usize = 0;
